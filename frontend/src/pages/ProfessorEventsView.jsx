...
const ProfessorEventsView = () => {
  ...
  // Load user's favorite events (for Professor users)
  useEffect(() => {
  ...
  // Load ratings and comments for viewing (VIEW ONLY)
                    ...
                    >
                      ...
                      {getEventTypeImage(event.type) && (
                        <div style={{
                          ...
                          />
                          {/* Heart Icon for Professor users */}
                          {user?.userType === 'Professor' && (
                            <button
                      ...
                      <div style={{ padding: (event.type === 'bazaar' || event.type === 'conference' || event.type === 'booth') ? '0.5rem' : '0.375rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{
                          display: 'flex',
                          flexDirection: 'column',
                          gap: event.type === 'booth' ? '0.75rem' : (event.type === 'bazaar' || event.type === 'conference') ? '0.625rem' : '0.25rem',
                          marginBottom: (event.type === 'bazaar' || event.type === 'conference' || event.type === 'booth') ? '0.625rem' : '0.375rem',
                          flex: 1
                        }}>
                          <div style={{
                            display: 'flex',
                        ...
                        {/* Average Rating Display - Bottom (Only for workshop/trip) */}
