...
const CreateGymSession = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Number(formData.maxParticipants) <= 0) {
      setMessage({ 
        type: 'error', 
        text: 'Max participants must be greater than 0' 
      });
      setLoading(false);
      return;
    }
    ...
    try {
      const result = await gymSessionApi.create(formData);
            ...
            <form onSubmit={handleSubmit} style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  >
                    Max Number of Participants <span style={{ color: '#ef4444' }}>*</span>
                  </label>
                  <input
                    type="number"
                    id="maxParticipants"
              ...
              <div style={{
                ...
                >
                  <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {loading ? 'Creating...' : 'Create Gym Session'}
                  </span>
                </button>
              </div>
            </form>
