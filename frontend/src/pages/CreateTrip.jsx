...
const CreateTrip = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await tripApi.create(formData);
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  <input
                    ...
                    placeholder="e.g., Geology Trip to the Alps"
                    required
                    style={{
                      width: '100%',
                      padding: '0.75rem',
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    ...
                    >
                      Price (EGP) <span style={{ color: '#ef4444' }}>*</span>
                    </label>
                    <input
                      type="number"
                      id="price"
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  <p style={{
                    ...
                    Briefly describe the trip's purpose and highlights.
                  </p>
                  <textarea
                    id="description"
                    name="description"
                    ...
                    onChange={handleChange}
                    placeholder="Briefly describe the trip's purpose and highlights."
                    rows={4}
                    style={{
                      width: '100%',
                      padding: '0.75rem',
